...
Notably, there are a few areas of limitations within our project. Firstly, given that our BJS correctional statistics report is from 2023, the data is not fully up to date in 2026 and there might be changes that are simply not reflecting in our findings. Given that recent years have seen an increase in incarcerations rates since a historic period of the decline from 2010-2021 as previously mentioned, we were especially interested in post-2022 data, which had a reported increase in prison population data of up by 2% (Bureau of Justice Statistics 2025). The earliest available data from BJS being only in 2023 is a significant limitation in itself. We also did not look into local incarceration rates and focused on state and federal populations, for which some states had different definitions for incarceration and jurisdiction.
